            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form action="{{ route('categories.update', $category) }}" method="POST">
                        ...
                        @php
                            $isCustomColor = str_starts_with($category->color, '#');
                            $currentColor = old('color', $category->color);
                            $currentColorType = old('color_type', $isCustomColor ? 'custom' : $category->color);
                        @endphp
                                ...
                                <label class="relative cursor-pointer group">
                                    ...
                                    <div class="flex flex-col items-center p-3 rounded-lg border-2 border-gray-200
                                        ...
                                        <div class="w-12 h-12 rounded-full mb-2 {{ $isCustomColor ? '' : 'bg-gradient-to-br from-red-500 via-yellow-500 to-blue-500' }}"
                                             style="{{ $isCustomColor ? 'background-color: ' . $category->color . ';' : '' }}"></div>
